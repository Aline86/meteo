class Caroussel {
    ...
    moveLeft = (e) => {
        ...
        this.count--
            ...
            if(this.direction == null || this.direction == 'right') {
                this.direction = 'left';
                this.translateRight = this.translateLeft - (document.querySelectorAll(".card")[6].clientWidth + 5);
            ...
            document.querySelectorAll(".card")[0].addEventListener("transitionend", () => {
                let firstCard = document.querySelector("."+  document.querySelectorAll(".card")[0].classList[0]);
    ...
    moveRight = (e) => {
        ...
        document.querySelector(".card-container").style.transform = "translate(" + -new_pos  + "px)";
            ...
            document.querySelector(".card-container").lastChild.addEventListener("transitionend", () => {
                console.log(this.translateLeft)
            })
